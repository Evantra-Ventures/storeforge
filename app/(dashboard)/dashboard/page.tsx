    ...
    <div className="space-y-8">
        ...
        <div className="relative grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center">
          <div className="lg:col-span-2">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
              ...
              activity, and keep your store running from one overview.
            </p>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur">
            ...
            <div className="mt-5 space-y-3">
              ...
              />
              <FocusItem
                label="Unread customer notifications"
      ...
      <section className="grid grid-cols-1 gap-8 xl:grid-cols-3">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <a
            href="/dashboard/marketing/email-queue"
            className="mt-5 block rounded-2xl border border-slate-200 px-5 py-3 text-center text-sm font-semibold hover:bg-slate-50"
          >
            Open email queue
          </a>
        </div>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm xl:col-span-2">
          <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Jump into the most important areas of your dashboard.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <QuickAction
              ...
              text="Manage your catalog, pricing, stock, variants, and product images."
              href="/products"
            />
            <QuickAction
              title="Review orders"
              text="Process orders, update delivery status, refunds, and customer updates."
              href="/orders"
            />
            <QuickAction
              title="Send announcements"
              text="Create coupon campaigns and notify customers about new offers."
              href="/dashboard/marketing/announcement"
            />
            <QuickAction
              title="Check analytics"
              text="Review performance, sales, customers, and store activity."
              href="/analytics"
            />
          </div>
        </div>
